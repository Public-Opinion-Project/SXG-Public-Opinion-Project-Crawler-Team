...
# 2. 包含modal_id的URL："https://www.douyin.com/user/xxx?modal_id=7525538910311632128"
# 3. 搜索页面的modal_id："https://www.douyin.com/root/search/python?modal_id=7525538910311632128"
...
# 指定抖音创作者URL列表（支持完整URL或sec_user_id）
# 支持格式：
